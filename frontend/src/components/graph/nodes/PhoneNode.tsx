...
export const PhoneNode: React.FC<{ data: PhoneNodeType; id: string }> = ({ data, id: _id }) => {
  ...
  return (
    ...
    >
      <div className="relative rounded-full py-1.5 px-3 border shadow-sm flex items-center gap-2 bg-amber-50/80 border-amber-200/80 text-amber-950 dark:bg-amber-950/30 dark:border-amber-500/30 dark:text-amber-200 shadow-amber-100/50 dark:shadow-amber-950/40 backdrop-blur-md cursor-pointer drop-shadow-md">
