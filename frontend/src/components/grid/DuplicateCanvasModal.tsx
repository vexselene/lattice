            ...
            <div className="flex flex-col select-none pr-8">
              <div className="flex items-center gap-2.5 mb-1.5">
                ...
                <h2 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white">
                  Duplicate Canvas<span className="text-[#DE6B80]">.</span>
                </h2>
              </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-1">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] text-slate-400 dark:text-slate-500 font-mono lowercase">
                    optional
                  </span>
                </div>
                <div className="border-b-2 border-slate-200 dark:border-slate-800 focus-within:border-[#DE6B80] dark:focus-within:border-[#DE6B80] transition-colors pb-1">
              ...
              <div className="flex items-center justify-end gap-3 pt-3">
                ...
                >
                  ...
                  {isSubmitting ? 'Duplicating…' : 'Duplicate Canvas'}
                </button>
              </div>
            </form>
          </motion.div>
